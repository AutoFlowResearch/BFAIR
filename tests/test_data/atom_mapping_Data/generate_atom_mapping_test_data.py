...
model, reaction_data, metabolite_data = INCA_input_parser.parse_cobra_model('e_coli_core.json', 'e_coli_core', '2021-07-15')

# Subset handpicked reactions
model_reaction_df = pd.DataFrame()
model_reaction_df = model_reaction_df.append(reaction_data[reaction_data['rxn_id'] == 'PFK'])
model_reaction_df = model_reaction_df.append(reaction_data[reaction_data['rxn_id'] == 'BIOMASS_Ecoli_core_w_GAM'])
model_reaction_df = model_reaction_df.append(reaction_data[reaction_data['rxn_id'] == 'EX_pyr_e'])
model_reaction_df = model_reaction_df.append(reaction_data[reaction_data['rxn_id'] == 'ICL'])

# And metabolites from these reactions
model_metabolite_df = pd.DataFrame()
model_metabolite_df = model_metabolite_df.append(metabolite_data[metabolite_data['met_id'] == 'atp_c'])
model_metabolite_df = model_metabolite_df.append(metabolite_data[metabolite_data['met_id'] == 'f6p_c'])
model_metabolite_df = model_metabolite_df.append(metabolite_data[metabolite_data['met_id'] == 'adp_c'])
model_metabolite_df = model_metabolite_df.append(metabolite_data[metabolite_data['met_id'] == 'fdp_c'])
model_metabolite_df = model_metabolite_df.append(metabolite_data[metabolite_data['met_id'] == 'h_c'])
model_metabolite_df = model_metabolite_df.append(metabolite_data[metabolite_data['met_id'] == 'pyr_e'])
model_metabolite_df = model_metabolite_df.append(metabolite_data[metabolite_data['met_id'] == 'icit_c'])
model_metabolite_df = model_metabolite_df.append(metabolite_data[metabolite_data['met_id'] == 'succ_c'])
model_metabolite_df = model_metabolite_df.append(metabolite_data[metabolite_data['met_id'] == 'glx_c'])
