...
atomMappingReactions_data_I = pd.read_csv('data_stage02_isotopomer_atomMappingReactions2.csv')
modelReaction_data_I = pd.read_csv('data_stage02_isotopomer_modelReactions.csv')
atomMappingMetabolite_data_I = pd.read_csv('data_stage02_isotopomer_atomMappingMetabolites.csv')
measuredFluxes_data_I = pd.read_csv('data_stage02_isotopomer_measuredFluxes.csv')
...
pickle.dump([modelReaction_data_I, atomMappingReactions_data_I, atomMappingMetabolite_data_I, measuredFluxes_data_I, experimentalMS_data_I, tracer_I, script, runner], filehandler)
